...
IC1. Iron Condor: best_spread_type="iron_condor" only when option_spreads.execution_candidates.iron_condor.raw_rr or effective_rr is in the 0.3-0.8 standard band, or in a high-credit extension band from 1.0-2.0 when worst_leg_bid_ask_spread_ratio <=0.05. 0.8-1.0 is marginal. <0.2 or >2.0 = avoid.
